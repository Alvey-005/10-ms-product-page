type CheckListProps = {
    title: string;
    checklistArray: string[];
    image: string;
};

const CheckList = ({ title, checklistArray, image }: CheckListProps) => {
    return (
        <div>
            <div className="flex flex-col gap-8 lg:flex-row lg:gap-4 mt-2 lg:mt-8">
                <div className="flex flex-col gap-4 text-left lg:w-[70%]">
                    <h3>{title}</h3>
                        ...
                        {checklistArray.map((item, idx) => (
                            <li key={idx}>
                                <div className="flex flex-row gap-4">
                                    ...
                                    <svg fill="#000000" height="20px" width="20px" id="Capa_1"
                                        viewBox="0 0 512 512">
                                        <g>
		...
		S509.502,87.794,504.969,83.262z"/>
                ...
                <div className="mb-4 mx-auto max-w-[350px]"><img className="w-full h-full md:w-[200px] md:h-[200px]" src={image} alt="" />
                </div>
            </div>
        </div>
    )
